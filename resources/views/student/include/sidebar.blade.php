        ...
        <ul class="sidebar-menu">
            ...
            <li class="dropdown">
                <a href="#" class="menu-toggle nav-link has-dropdown"><i
                        data-feather="briefcase"></i><span>Application</span></a>
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="{{ route('createApp') }}">Create</a></li>
                    <li><a class="nav-link" href="{{ route('indexApp') }}">View</a></li>
                </ul>
            </li>
            <li class="dropdown">
                <a href="{{ route('indexDocs') }}" class="nav-link"><i
                        data-feather="command"></i><span>Documents</span></a>
            </li>
            {{--
        <li class="dropdown">
